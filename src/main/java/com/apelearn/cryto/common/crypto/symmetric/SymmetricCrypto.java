...
public class SymmetricCrypto implements Crypto {
	...
	public SymmetricCrypto(String algorithm, byte[] key) {
		this(algorithm, KeyGenerator.generateKey(algorithm, key));
	}
	...
	/*public String encrypt2Hex(byte[] data){
		return RadixUtil.toHex(encrypt(data));
	}*/
	 ...
	 * @return 加密后的bytes
	 */
    public byte[] encrypt2Bytes(String data, String charset){
	 ...
	 * @return 加密后的bytes
	 */
	public byte[] encrypt2Bytes(String data){
	...
	public String encrypt(String data, String charset){
		return RadixUtil.toHex(encrypt2Bytes(data, charset));
	}
	...
	public String encrypt(String data) {
		return RadixUtil.toHex(encrypt2Bytes(data));
	}
	 ...
	 * @return 解密后的String
	 */
	public String decrypt2Str(byte[] bytes, Charset charset){
	 ...
	 * @return 解密后的String
	 */
	public String decrypt2Str(byte[] bytes){
		return decrypt2Str(bytes, CharsetUtil.CHARSET_UTF_8);
	}
	 ...
	 * @return 解密后的bytes
	 */
	public byte[] decrypt2Bytes(String data) {
		return decrypt(RadixUtil.toBytes(data));
	}
	...
	public String decrypt(String data, Charset charset){
		return StrUtil.str(decrypt2Bytes(data), charset);
	}

	@Override
	public String decrypt(String src, String charset) {
		return decrypt(src , CharsetUtil.charset(charset));
	}
	...
	public String decrypt(String data) {
		return decrypt(data, CharsetUtil.CHARSET_UTF_8);
	}
